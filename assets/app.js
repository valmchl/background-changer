$(document).ready(function(){
	...
	$("#custom__submit").click(function(){
		...
		$("<style type='text/css'>body#bg_custom, #bg_custom .maintitle, #bg_custom #header, #bg_custom .footer{ background-image: url(" + customurl + ")}</style>").appendTo("head");
	...
	if ( (('custom_url') != null))	{
		$("<style type='text/css'>body#bg_custom, #bg_custom .maintitle, #bg_custom #header, #bg_custom .footer{ background-image: url(" + $('custom_url') + ")}</style>").appendTo("head");
